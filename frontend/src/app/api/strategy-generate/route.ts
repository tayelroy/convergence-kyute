      ...
      properties: {
        ETHUSDC: {
          ...
          properties: {
            ...
            mode: { type: ["string", "null"], enum: ["default_hedge", "dynamic_regime_hedge", null] },
            entryThresholdBp: { type: ["number", "null"] },
            exitThresholdBp: { type: ["number", "null"] },
          },
          required: ["enabled", "mode", "entryThresholdBp", "exitThresholdBp"],
        },
        BTCUSDC: {
          type: "object",
          additionalProperties: false,
...
const buildPrompt = (input: {
  ...
  return [
    ...
    "If unchanged, set each field to null for that market.",
